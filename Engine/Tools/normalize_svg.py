...
Usage:
  python Engine/Tools/normalize_svg.py Assets/Editor/Folder.svg
  python Engine/Tools/normalize_svg.py Assets/Editor/*.svg --in-place
  python Engine/Tools/normalize_svg.py Assets/Editor --in-place --round-canvas
  python Engine/Tools/normalize_svg.py icon.svg --canvas 256 --dry-run
"""
