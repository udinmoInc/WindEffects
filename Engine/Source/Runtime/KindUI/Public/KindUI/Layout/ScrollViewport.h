// ==============================================================================
// WindEffects — KindUI — ScrollViewport
...
public:
    ...
    void Paint(PaintContext& context, const ScrollViewportMetrics& metrics, bool thumbHovered, const Color* trackColor)
        const;

    bool OnMouseDown(const MouseEvent& event, const ScrollViewportMetrics& metrics, float viewportHeight,
        float contentHeight);
    void OnMouseMove(const MouseEvent& event, const ScrollViewportMetrics& metrics, float viewportHeight,
        float contentHeight);
