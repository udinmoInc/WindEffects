...
class KINDUI_API FloatAnimation : public Animation {
public:
...
// Color animation
struct Color;
class KINDUI_API ColorAnimation : public Animation {
public:
...
// Animation manager
class KINDUI_API AnimationManager {
public:
