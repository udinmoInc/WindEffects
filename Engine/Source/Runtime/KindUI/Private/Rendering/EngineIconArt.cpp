// ==============================================================================
// WindEffects — KindUI — EngineIconArt
...
// ==============================================================================
#include "Rendering/EngineIconArt.h"

#include "Rendering/EngineIconBitmap.h"
#include "KindUI/Host/IconRenderer.h"
#include "KindUI/Core/DPIContext.h"

// Icon GPU textures are owned by IconManager (individual PNG cache); EngineIconArt is CPU art only.
