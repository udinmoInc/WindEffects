...
// Engine-internal glm bridge for Private translation units.
// Do not include from Public module API headers.
...
// Layout-compatible views for Private TUs that still call glm APIs.
