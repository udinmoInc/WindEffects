// ==============================================================================
// WindEffects — WeLauncher — LauncherHelpers
...
inline constexpr float kLauncherContentPadX = 16.0f;
inline constexpr float kLauncherContentPadTop = 32.0f;
inline constexpr float kLauncherContentPadBottom = 16.0f;
inline constexpr float kLauncherTitleToToolbar = 24.0f;
inline constexpr float kLauncherToolbarToDivider = 16.0f;
inline constexpr float kLauncherDividerToTable = 16.0f;
inline constexpr float kLauncherToolbarControlGap = 8.0f;
