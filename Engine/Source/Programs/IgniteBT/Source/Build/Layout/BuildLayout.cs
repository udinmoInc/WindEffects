...
public sealed class BuildLayout
{
    ...
    public string PlatformManifestRoot => Path.Combine(ManifestDirectory, PlatformFolder, ConfigurationFolder);
    ...
    public string ImportLibraryRoot => Path.Combine(PlatformIntermediateRoot, "ImportLibs");

    public string GetModuleImportLibraryDirectory(string moduleName) =>
        Path.Combine(ImportLibraryRoot, moduleName);

    public string GetModuleImportLibraryPath(string moduleName, string importLibraryFileName) =>
        Path.Combine(GetModuleImportLibraryDirectory(moduleName), importLibraryFileName);
    ...
    public string GetOutputLayoutManifestPath() =>
        Path.Combine(PlatformManifestRoot, BuildManifestFiles.OutputLayout);
    ...
    public void EnsureDirectories()
    {
        ...
        Directory.CreateDirectory(PlatformManifestRoot);
