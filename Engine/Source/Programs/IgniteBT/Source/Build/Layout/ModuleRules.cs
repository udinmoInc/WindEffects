...
public abstract class ModuleRules
{
    ...
    /// <summary>
    /// Optional output file name for the module binary (for example WindeffectsEditor.exe).
    /// </summary>
    public string? BinaryName { get; set; }

    /// <summary>
    /// Explicit output placement. When unspecified, placement is inferred from module metadata.
    /// </summary>
    public OutputPlacement OutputPlacement { get; set; } = OutputPlacement.Unspecified;

    /// <summary>
    /// Output directory (relative to build output). Deprecated: use OutputPlacement instead.
    /// </summary>
    public string? OutputDirectory { get; set; }

    /// <summary>
    /// Whether this module is a bootstrap engine DLL published at the configuration root.
    /// </summary>
    ...
    /// <summary>
    /// Sets the built binary file name for this module.
    /// </summary>
    protected void SetBinaryName(string binaryName)
    {
        BinaryName = binaryName;
    }

    /// <summary>
    /// Publishes this module as a bootstrap binary at the configuration output root.
    /// </summary>
    protected void BootstrapBinary()
    {
        IsBootstrapBinary = true;
        OutputPlacement = OutputPlacement.ConfigurationRoot;
    }

    /// <summary>
    /// Publishes this module's executable at the configuration output root.
    /// </summary>
    protected void PublishAtConfigurationRoot()
    {
        OutputPlacement = OutputPlacement.ConfigurationRoot;
    }

    /// <summary>
    /// Publishes this module under Programs/{ModuleName}/.
    /// </summary>
    protected void PublishAsProgram()
    {
        OutputPlacement = OutputPlacement.Program;
    }
