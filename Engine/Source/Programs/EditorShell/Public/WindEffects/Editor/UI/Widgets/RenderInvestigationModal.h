// ==============================================================================
// WindEffects — EditorShell — RenderInvestigationModal
...
class EDITORSHELL_API RenderInvestigationModal : public Widget {
public:
...
class EDITORSHELL_API RenderInvestigationModalHost {
public:
    static void Toggle();
    static void Show();
    static void Hide();
