// ==============================================================================
// WindEffects — EditorShell — EditorApplicationContext
...
class EDITORSHELL_API IEditorApplicationContext : public IApplicationContext {
public:
...
public:
    ...
    EDITORSHELL_API explicit EditorApplicationContext(
        std::shared_ptr<IKindUITheme> theme = nullptr);

    EDITORSHELL_API void Initialize(float dpiScale = 1.0f);
    EDITORSHELL_API void Shutdown();
