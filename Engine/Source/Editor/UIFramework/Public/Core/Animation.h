...
class UIFRAMEWORK_API Animation {
public:
...
class UIFRAMEWORK_API FloatAnimation : public Animation {
public:
...
// Color animation
struct Color;
class UIFRAMEWORK_API ColorAnimation : public Animation {
public:
...
// Animation manager
class UIFRAMEWORK_API AnimationManager {
public:
