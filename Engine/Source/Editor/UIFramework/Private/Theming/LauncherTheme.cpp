...
Color LauncherTheme::GetColor(ThemeToken token) const {
    ...
    case ThemeToken::Separator:               return LnHex(0x32, 0x32, 0x32);
    case ThemeToken::BorderDark:              return LnHex(0x32, 0x32, 0x32);
    case ThemeToken::BorderDefault:           return LnHex(0x3A, 0x3A, 0x3A);
    case ThemeToken::BorderLight:             return LnHex(0x48, 0x48, 0x48);

    case ThemeToken::IconAccent:              return LnHex(0x2F, 0x6F, 0xEB);
    case ThemeToken::AccentPrimary:           return LnHex(0x2F, 0x6F, 0xEB);
    case ThemeToken::AccentHover:             return LnHex(0x4A, 0x84, 0xF0);
    case ThemeToken::BorderFocus:             return LnHex(0x2F, 0x6F, 0xEB);
    case ThemeToken::ActiveTabLine:           return LnHex(0x2F, 0x6F, 0xEB, 0.85f);
    case ThemeToken::LinkForeground:          return LnHex(0x4A, 0x84, 0xF0);
    case ThemeToken::PlayForeground:          return LnHex(0x2F, 0x6F, 0xEB);

    case ThemeToken::ButtonPrimaryBackground: return LnHex(0x2F, 0x6F, 0xEB);
    case ThemeToken::ButtonPrimaryHover:      return LnHex(0x4A, 0x84, 0xF0);
    case ThemeToken::ButtonPrimaryPressed:    return LnHex(0x25, 0x60, 0xD4);

    case ThemeToken::SelectedBackground:      return LnHex(0x2F, 0x6F, 0xEB, 0.30f);
    case ThemeToken::SelectionHighlight:      return LnHex(0x2F, 0x6F, 0xEB, 0.22f);
