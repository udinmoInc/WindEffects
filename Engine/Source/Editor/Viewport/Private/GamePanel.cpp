...
std::shared_ptr<Panel> CreateGamePanel() {
    auto toolbar = ToolbarBuilder()
        ...
        .Dropdown(WindIcons::PlayGreen16, "Game", {}, "Game View Options")
        .Separator()
        .Dropdown(WindIcons::Camera16, "Display 1", {}, "Select Display")
        .Separator()
        .Dropdown(WindIcons::Scaling16, "Auto Resolution", {}, "Select Resolution")
        .Separator()
        .Dropdown(WindIcons::AdjustmentHorizontal16, "Free Aspect", {}, "Aspect Ratio")
        .Separator()
        .Dropdown(WindIcons::Plus16, "1x", {}, "View Scale")
        .Separator()
        .Dropdown(WindIcons::Eye16, "Play Focus", {}, "Play Focus Mode")
        .Separator()
        .Item(WindIcons::Logs16, "Stats", {}, "Toggle Stats")
        .Separator()
