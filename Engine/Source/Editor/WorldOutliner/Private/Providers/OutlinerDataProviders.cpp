// ==============================================================================
// WindEffects — WorldOutliner — OutlinerDataProviders
...
we::runtime::kindui::WindIconRef IconForEntityType(scene::EntityType type) {
    ...
    case EntityType::Character: return we::runtime::kindui::WindIcons::Accessibility16;
    case EntityType::CameraIcon: return we::runtime::kindui::WindIcons::ToolbarCamera16;
    case EntityType::AudioSource: return we::runtime::kindui::WindIcons::Speaker16;
